...
function Header() {
    return (
        <header className={`${styles.header} px-3 pt-3 px-lg-0 pt-lg-0`} id="header">
            <nav className={`${styles.desktop_navbar} navbar`}>
                ...
                <div className="d-none d-lg-flex align-items-center gap-5">
                    <ul className={`d-lg-flex m-0 ${styles.desktop_list} ${styles.castoro_regular_italic}`}>
                        <li><a href="#category" className={styles.link_menu}>Categorias</a></li>
                        <li><a href="#favorite" className={styles.link_menu}>Favoritos</a></li>
                        <li><a href="#about" className={styles.link_menu}>Sobre</a></li>
                        <li><a href="#contact" className={styles.link_menu}>Contato</a></li>
                    </ul>
                    ...
                    <div className="offcanvas-body p-0 mt-4">
                        <ul className={`navbar-nav gap-4 ${styles.castoro_regular_italic}`}>
                            <li className="nav-item">
                                <a href="#category" className={`${styles.link_menu} nav-link ps-3`}>Categorias</a>
                            </li>

                            <li className="nav-item">
                                <a href="#favorite" className={`${styles.link_menu} nav-link ps-3`}>Favoritos</a>
                            </li>

                            <li className="nav-item">
                                <a href="#about" className={`${styles.link_menu} nav-link ps-3`}>Sobre</a>
                            </li>

                            <li className="nav-item">
                                <a href="#contact" className={`${styles.link_menu} nav-link ps-3`}>Contato</a>
                            </li>
                        </ul>
